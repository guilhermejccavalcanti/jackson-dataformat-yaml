...
public class YAMLParser extends ParserBase {
    ...
    protected JsonLocation _locationFor(Mark m) {
        ...
        return new JsonLocation(_ioContext.getSourceReference(), -1, m.getLine() + 1, m.getColumn() + 1);
    }
        ...
        while (true) {
            ...
            try {
                ...
                if (e instanceof org.yaml.snakeyaml.error.MarkedYAMLException) {
                    throw com.fasterxml.jackson.dataformat.yaml.snakeyaml.error.MarkedYAMLException.from(this, (org.yaml.snakeyaml.error.MarkedYAMLException) e);
                }
    ...
    public String getTypeId() throws IOException, JsonGenerationException {
        ...
        if (_lastEvent instanceof CollectionStartEvent) {
            ...
            if (_lastEvent instanceof ScalarEvent) {
